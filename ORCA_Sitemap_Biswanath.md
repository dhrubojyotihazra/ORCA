...
"Which language do you prefer?"
  o English   o हिन्दी (Hindi)
  o বাংলা (Bengali)  o मराठी (Marathi)
  o தமிழ் (Tamil)
                  [Next ->]
```
...
"What kind of vessel do you use?"
  o Small boat (< 8m)
  o Medium trawler (8-15m)
  o Large vessel (> 15m)
  o I'd rather skip this
                  [Get Started ->]
```
...
|                                                 |
| [See detailed charts v]  <- collapsed by default|
...
**"See detailed charts v" accordion:**
