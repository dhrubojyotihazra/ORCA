...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 z-10 rounded-inherit bg-[#050B14]/40"
      />
      <div
        className="absolute inset-0 z-20 rounded-inherit rounded-3xl overflow-hidden pointer-events-none"
        style={{
          boxShadow:
            "inset 2px 2px 1px 0 rgba(255, 255, 255, 0.35), inset -1px -1px 1px 1px rgba(255, 255, 255, 0.2), 0 10px 30px rgba(0,0,0,0.5)",
        }}
      />
